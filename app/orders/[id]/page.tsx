    ...
    <>
      ...
      <div className="min-h-screen bg-neutral-50 py-8">
        <div className="container mx-auto px-4">
          <Link href="/orders" className="text-lime-600 mb-4 inline-block">
            ← Back to Orders
          </Link>
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {order.address && (
                <div className="bg-white p-6 rounded-lg shadow">
                  ...
                  <p className="text-neutral-600">{order.address.recipient_name}</p>
                ...
                {!payment ? (
                  <div>
                    ...
                    <button
                      ...
                      className="w-full bg-lime-600 text-white py-3 rounded-lg font-medium hover:bg-lime-700 disabled:bg-neutral-400 transition"
                    >
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <span className={`font-medium ${
                        payment.status === 'paid' ? 'text-lime-600' : 
                    ...
                    {payment.status === 'pending' && (
                      <div className="pt-4 border-t">
                        ...
                        <button
                          ...
                          disabled={processingPayment}
                          className="w-full bg-blue-600 text-white py-2 rounded-lg font-medium hover:bg-blue-700 disabled:bg-neutral-400 transition"
                        >
                    ...
                    {payment.status === 'paid' && (
                      <div className="pt-4 border-t">
                        <div className="bg-lime-50 text-lime-700 p-4 rounded-lg text-center">
                          ✓ Payment Complete
                        </div>
                      </div>
                    )}
